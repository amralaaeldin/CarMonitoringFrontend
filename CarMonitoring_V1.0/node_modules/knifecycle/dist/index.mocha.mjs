...
import { SPECIAL_PROPS, Knifecycle, initializer, inject, constant, service, provider } from './index';
...
describe('Knifecycle', () => {
  ...
  describe('run', () => {
    ...
    it('should work with service dependencies', async () => {
      $.register(service(inject(['time'], function sampleService({
        time
      }) {
